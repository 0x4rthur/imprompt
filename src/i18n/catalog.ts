...
const en = {
  ...
  "motor.fastMode": "Prioritize speed",
  "motor.fastMode.help": "Uses the lowest supported reasoning effort on known models. Faster for editing and translation; turn off for complex reasoning. Keeps your model and standard pricing. Unknown servers keep their defaults.",
  ...
  "geral.theme.dark": "Dark",
  "geral.theme.help": "System follows your OS light or dark mode.",
...
const ptBR: Record<keyof typeof en, string> = {
  ...
  "motor.fastMode": "Priorizar velocidade",
  "motor.fastMode.help": "Usa o menor esforço de raciocínio compatível nos modelos conhecidos. Mais rápido para edição e tradução; desligue para raciocínio complexo. Mantém seu modelo e a tarifa padrão. Servidores desconhecidos mantêm seus padrões.",
  ...
  "geral.theme.dark": "Escuro",
  "geral.theme.help": "Sistema acompanha o modo claro ou escuro do seu SO.",
